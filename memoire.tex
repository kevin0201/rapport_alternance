...
\usepackage[top=2.5cm, bottom=2.5cm, left=2.5cm, right=2.5cm]{geometry} % définition des marges
...
% Introduction
\input{textes/intro.tex}

\input{textes/part1.tex}

\input{textes/part2.tex}
